# Manual completo v2.2 — dónde está ahora
...
Este manual y el breve cubrían los mismos seis módulos con distinta profundidad: dos
documentos que mantener y, en la práctica, dos verdades. Además se desincronizaban de la
aplicación — el breve llegó a declarar «Versión 1.6 · Mayo 2026» tres versiones después
de la que estaba en producción.

Ahora ambos niveles salen del mismo texto.
